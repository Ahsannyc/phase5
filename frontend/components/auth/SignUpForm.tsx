...
export default function SignUpForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Note: Better Auth typically handles registration differently
  ...
  return (
    <GlassCard>
      <h2 className="text-2xl font-bold text-slate-100 mb-6 text-center">Sign Up</h2>
      {error && (
      ...
      <div className="mt-4 text-center text-sm text-slate-400">
        ...
        <a href="/signin" className="text-cyan-400 hover:text-cyan-300 underline">
          Sign in
        </a>
      </div>
    </GlassCard>
